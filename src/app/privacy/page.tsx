export default async function Privacy() {
  return (
    <div className="p-8">
      {" "}
      <h1>Privacy Policy for www.pokedex-next.online</h1>
      <p>
        At Pokedex, accessible from https://www.pokedex-next.online, one of our
        main priorities is the privacy of our visitors. This Privacy Policy
        document contains types of information that is collected and recorded by
        Pokedex and how we use it.
      </p>
      <p>
      ...
      <p>
        www.pokedex-next.online legal basis for collecting and using the
      ...
      <ul>
        <li>www.pokedex-next.online needs to perform a contract with you</li>
        <li>You have given www.pokedex-next.online permission to do so</li>
        <li>
          Processing your personal information is in www.pokedex-next.online
          legitimate interests
        </li>
        <li>www.pokedex-next.online needs to comply with the law</li>
      </ul>
      <p>
        www.pokedex-next.online will retain your personal information only for
      ...
      <h2>Log Files</h2>
      <p>
        Pokedex follows a standard procedure of using log files. These files log
      ...
      <p>
        Like any other website, Pokedex uses &apos;cookies&apos;. These cookies
      ...
      <p>
        ...
        advertising partners of Pokedex.
      </p>
      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on Pokedex, which are sent directly
      ...
      <p>
        Note that Pokedex has no access to or control over these cookies that
        are used by third-party advertisers.
      </p>
      <h2>Third Party Privacy Policies</h2>
      <p>
        Pokedex&apos;s Privacy Policy does not apply to other advertisers or
      ...
      <p>
        Pokedex does not knowingly collect any Personal Identifiable Information
      ...
      <p>
        ...
        shared and/or collect in Pokedex. This policy is not applicable to any
